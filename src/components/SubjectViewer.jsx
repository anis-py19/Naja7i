            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {filteredBacs.map((item) => (
                  <div
                    key={item.id}
                    className="bg-[#F8FAFC] border border-[#E2E8F0] hover:border-[#CBD5E1] rounded-xl p-3.5 flex flex-col justify-between shadow-2xs transition-all"
                  >
                    <div>
                      ...
                      <h4 className="text-xs font-bold text-[#0F172A] mb-2 leading-snug">
                        {item.sujetTitle}
                      </h4>
                    </div>
                      ...
                      <div className="flex items-center gap-1">
                        {item.sujetUrl && (
                          <button
                            ...
                            className="px-2.5 py-1 rounded bg-white hover:bg-[#0284C7] hover:text-white text-[#0F172A] text-[11px] font-bold border border-[#CBD5E1] transition-colors flex items-center gap-1 cursor-pointer"
                          >
                        ...
                        {item.corrigeUrl && (
                          <button
                            ...
                            className="px-2.5 py-1 rounded bg-white hover:bg-[#16A34A] hover:text-white text-[#0F172A] text-[11px] font-bold border border-[#CBD5E1] transition-colors flex items-center gap-1 cursor-pointer"
                          >
