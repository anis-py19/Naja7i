...
export default function CalculatorPage() {
  ...
  if (average >= 18) {
    ...
    mentionBadge = 'bg-red-50 text-red-700 border border-red-200';
  ...
  return (
    <div className="min-h-screen bg-[#FFFAF3] text-[#1c1917] pb-16 font-['Cairo']">
      ...
      <div className="bg-[#FFF2DB] border-b border-[#FFE5BF] py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2 text-xs text-[#78716c] mb-3">
            ...
            <span>/</span>
            <span className="text-[#1c1917] font-bold">حاسبة معدل البكالوريا</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs text-[#78716c]">حساب فوري للمعدل والتقدير</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <div className="bg-white border border-[#FFE5BF] rounded-2xl p-4 mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Inputs Box */}
          <div className="lg:col-span-2 bg-white border border-[#FFE5BF] rounded-2xl p-5 sm:p-6 space-y-4">
            
            <div className="flex items-center justify-between border-b border-[#FFE5BF] pb-3">
              <div>
                <h3 className="text-sm font-bold text-[#1c1917]">
                  النقاط المتوقعة (من 0 إلى 20):
                </h3>
                <span className="text-[11px] text-[#78716c]">
                  مجموع معاملات شعبة {currentStream.name}: <strong className="font-mono text-[#F62440]">{totalCoefficients}</strong>
                </span>
              </div>

              <button
                onClick={handleReset}
                className="px-2.5 py-1 rounded-lg bg-[#FFF2DB] hover:bg-[#FFE5BF] text-[#57534e] hover:text-[#1c1917] text-xs font-bold border border-[#FFE5BF] flex items-center gap-1 transition-colors cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {currentStream.subjects.map((sub) => {
                ...
                return (
                  <div 
                    key={sub.id}
                    className="p-3 rounded-xl bg-[#FFFAF3] border border-[#FFE5BF] flex items-center justify-between gap-2"
                  >
                    <div className="min-w-0">
                      ...
                      <span className="text-[11px] text-[#78716c]">
                        المعامل: <strong className="text-[#F62440] font-mono">{sub.coef}</strong>
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <input
                        ...
                        className="w-16 bg-white border border-[#FFE5BF] rounded-lg px-2 py-1 text-center text-sm font-bold font-mono text-[#1c1917] focus:outline-none focus:border-[#F62440]"
                      />
                      <span className="text-xs text-[#78716c]">/20</span>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="space-y-4">
            ...
            {/* Average Card */}
            <div className="bg-[#FFF2DB] border border-[#FFE5BF] rounded-2xl p-6 text-center space-y-3">
              <span className="text-xs font-bold text-[#78716c] block">
                المعدل العام التقديري
              </span>

              <div className="text-4xl sm:text-5xl font-black font-mono text-[#F62440]">
                {formattedAverage}
                <span className="text-sm font-bold text-[#57534e] mr-1">/ 20</span>
              </div>

              <div>
                <span className={`inline-block px-3 py-1 rounded-md text-xs font-bold ${mentionBadge}`}>
                  {mention}
                </span>
              </div>

              <div className="pt-3 border-t border-[#FFE5BF] grid grid-cols-2 gap-2 text-xs">
                <div className="p-2 bg-white rounded-lg border border-[#FFE5BF]">
            ...
            <div className="bg-white border border-[#FFE5BF] rounded-2xl p-5 space-y-2.5">
              ...
              <ul className="space-y-1.5">
                {suggestions.map((sug, i) => (
                  <li key={i} className="text-xs text-[#57534e] flex items-start gap-1.5 leading-relaxed">
