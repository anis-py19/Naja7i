          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#475569] mt-1 max-w-2xl leading-relaxed">
                بنك شامل ومنظم لمواضيع البكالوريا الرسمية والتصحيحات وسلالم التنقيط الوزارية المعتمدة، مع إمكانية المعاينة الفورية والتحميل المباشر بدون إعلانات.
              </p>
            </div>
