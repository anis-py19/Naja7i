      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 space-y-8">
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 sm:p-10 shadow-xs relative overflow-hidden space-y-6">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl overflow-hidden border-2 border-[#E11D48] shadow-md shrink-0 bg-slate-100">
              <img 
                src="/anis-izri.jpg" 
            ...
            <div className="space-y-2 text-center sm:text-right">
              ...
              <p className="text-xs sm:text-sm text-[#475569] leading-relaxed">
                «مرحباً بكم.. أنا أنيس ازري، طالب في تخصص إدارة الأعمال (Business Management). عشت كأي طالب جزائري رحلة التحضير لشهادة البكالوريا وما فيها من ضغط نفسي وتشتت بين قنوات التيليجرام ومواقع التحميل وروابط الإعلانات المزعجة. من هنا جاءت فكرة تأسيس منصة <strong>«نجاحي»</strong> لتكون مرجعاً نقياً ومرتباً يوفر على الطالب وقته وجهده.»
              </p>
            </div>
          </div>
