          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
            ...
            <div className="space-y-2 text-center sm:text-right">
              ...
              <h2 className="text-lg sm:text-xl font-bold text-[#0F172A]">
                أنيس إيزري (Anis Izri) — طالب في إدارة الأعمال
              </h2>
              <p className="text-xs sm:text-sm text-[#475569] leading-relaxed">
                «مرحباً بكم.. أنا أنيس إيزري، طالب في تخصص إدارة الأعمال (Business Management). عايشت كأي طالب جزائري رحلة التحضير لشهادة البكالوريا وما فيها من ضغط نفسي وتشتت بين قنوات التيليجرام ومواقع التحميل وروابط الإعلانات المزعجة. من هنا جاءت فكرة تأسيس منصة <strong>«نجاحي»</strong> لتكون مرجعاً نقياً ومرتباً يوفر على الطالب وقته وجهده.»
              </p>
            </div>
          </div>
